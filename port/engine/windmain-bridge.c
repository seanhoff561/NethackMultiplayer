/* Modified 2026-09-07 for NetHack: Descent: headless main, shim window port,
 * and isolated portable paths. Original copyright and license below apply. */
...
#if !defined(MSWIN_GRAPHICS)
    /* headless bridge owns input and output */
