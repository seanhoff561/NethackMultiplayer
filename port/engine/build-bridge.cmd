...
set "CL=/FIinttypes.h"
cd /d "%~dp0..\..\src"
set "BFLAGS=/nologo /c /MT /O2 /DWIN32 /DWIN64 /D_WIN64 /DWIN32CON /D_CONSOLE /DHAS_STDINT_H /DHAS_INLINE /D_CRT_SECURE_NO_DEPRECATE /D_CRT_NONSTDC_NO_DEPRECATE /DDLB /DSHIM_GRAPHICS /DDESCENT_SPATIAL /DCHDIR /I..\include /I..\sys\windows /I..\submodules\lua"
...
if errorlevel 1 exit /b 1
cl %BFLAGS% /Fo..\port\engine\build\monmove.o monmove.c
if errorlevel 1 exit /b 1
cl %BFLAGS% /Fo..\port\engine\build\mhitu.o mhitu.c
if errorlevel 1 exit /b 1
...
if errorlevel 1 exit /b 1
cl %BFLAGS% /Fo..\port\engine\build\uhitm.o uhitm.c
if errorlevel 1 exit /b 1
