...
Double-click **`Play NetHack 3D.cmd`** in the repository root. It starts the local server and opens the game in a standalone Chrome window, or your default browser if Chrome is unavailable. The polished executable is already built for Windows x64. This launcher opens version 0.5 on port 5176; the earlier builds on 5173, 5174 and 5175 and their save directories remain separate. Node.js 22 or newer and a browser supporting WebGL 2 are required.
...
| Space / Z | Choose a spell to cast |
...
| Escape | Open the Expedition menu; cancel a pending choice. From a menu subpage, return to Settings; from Settings, resume |
