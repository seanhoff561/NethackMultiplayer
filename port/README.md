...
Double-click **`Play NetHack 3D.cmd`** in the repository root. It starts the local server and opens the game in a standalone Chrome window, or your default browser if Chrome is unavailable. The polished executable is already built for Windows x64. This launcher opens version 0.7 on port 5178; the earlier builds on 5173–5177 and their save directories remain separate. Node.js 22 or newer and a browser supporting WebGL 2 are required.
