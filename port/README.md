...
Each of the thirteen classes has its own voxel outfit, headgear, weapon, walking/attacking rig and overhead name. Enemy health scales by **1 / 1.65 / 2.30 / 2.95**, and damage by **1 / 1.18 / 1.36 / 1.54**, for one through four connected adventurers. Changing party size preserves each enemy's remaining health fraction. Nearby fallen allies can be revived from the Party menu. A full party wipe regroups at the entrance after five seconds, costing 20% of carried gold.
...
**Compatibility boundary:** co-op is a separate cooperative ruleset over native-generated dungeon content, currently covering main-dungeon depths 1–25. It is not full multiplayer conversion of NetHack's C rules. The co-op command palette lists its supported actions. Consumables, tools, spell effects, containers, traps, armor and combat use simplified cooperative rules; native quests, branch routing, shops, artifact effects, polymorph, complex item interactions and ascension are not implemented in co-op. Solo retains the native rules described below. This remains a development build; internet connectivity and balance need testing on the actual players' networks.
